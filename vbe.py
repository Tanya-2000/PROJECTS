...
#choices
print ("1. compose an email.")
tts = gTTS(text="option 1. compose an email.", lang='en')
ttsname=("hello.mp3") 
tts.save(ttsname)
...
if text == '1' or text == 'One' or text == 'one':
    ...
    mail.login('mostameues2004@gmail.com','CHINCHU2004') #login part
    mail.sendmail('mostameues2004@gmail.com','tanyasac56@gmail.com',msg) #send part
...
if text == '2' or text == 'tu' or text == 'two' or text == 'Tu' or text == 'to' or text == 'To' :
    ...
    unm = ('mostameues2004@gmail.com')  #username
    psw = ('CHINCHU2004')  #password
